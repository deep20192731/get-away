...
public class MainActivity extends FragmentActivity {
     ...
     */
    private static final String CLIENT_ID = "ZTBKSZQTIPYZRTW1S5B02YMY1RQDSTCNN0AOR0T2I0M14CQ5";
    private static final String CLIENT_SECRET = "AWUWU0WIBKQHHLANRERSP42BSVU2GAIDVQCIH0OVH4QHDGJG";
    private static final String LOG_TAG = "MainActivity";

    /** App made on my account
     private static final String CLIENT_ID = "3P1AIBKNB4BF2AUVYAIW5OFGG3ZU55MMKVUDBXYUH4IBHVG5";
     private static final String CLIENT_SECRET = "14PFIR3ZBS5IR3WWVO5HX3BIFGDGH4YMIGMA20DQTW5HWZFT";
     */
    ...
    public class MyThread extends Thread{
        ...
        public void run() {
            ...
            try {
                ...
                MyBean bean = api.register(accessToken, token).execute();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        switch (requestCode) {
            ...
            case REQUEST_CODE_FSQ_TOKEN_EXCHANGE:
                ...
                startActivity(new Intent(this, RecomDrawerActivity.class));
                break;
            default:
